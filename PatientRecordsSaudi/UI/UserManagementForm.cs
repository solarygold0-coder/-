...
namespace PatientRecordsSaudi.UI
{
    ...
    internal sealed class PasswordDialog : Form
    {
        ...
        private void Save(object sender, EventArgs e) { if (password.Text != confirm.Text) { UiKit.ShowError("كلمتا المرور غير متطابقتين."); return; } DialogResult = DialogResult.OK; Close(); }
    }
