...
namespace PatientRecordsSaudi.WinUI
{
    internal static class EditorDialogs
    {
        ...
        private sealed class FormHost
        {
            ...
            public DateTimeSpinner Date(string header, DateTime value, bool withTime) { Panel.Children.Add(new TextBlock { Text = header }); var c = new DateTimeSpinner(withTime) { Value = value }; Panel.Children.Add(c); return c; }
