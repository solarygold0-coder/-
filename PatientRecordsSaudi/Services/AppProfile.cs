...
namespace PatientRecordsSaudi.Services
{
    ...
    {
        public const string DataFolderName = "SaudiPatientRecordsV5";
        public const string GenerationMarkerName = ".generation-v5";
        ...
        public static void Initialize(string dataDirectory)
        {
            ...
            if (!File.Exists(marker)) File.WriteAllText(marker, "Saudi Patient Records independent data generation 5");
        }
    }
}
